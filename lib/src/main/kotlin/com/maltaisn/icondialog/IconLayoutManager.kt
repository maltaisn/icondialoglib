...
/**
 * Thin subclass around grid layout manager to adjust the span count from
 * the layout width and the specified icon width.
 */
internal class IconLayoutManager(context: Context, private val iconSize: Int) :
    ...
    override fun onLayoutChildren(recycler: Recycler, state: RecyclerView.State) {
        if (spanCount == -1 && iconSize > 0 && width > 0 && height > 0) {
            ...
            spanCount = max(1, layoutWidth / iconSize)
        }
